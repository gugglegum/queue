...
/**
 * Конструктор. Принимает на вход экземпляр очереди, с которой предстоит производить
 * манипуляции, и сохраняет его во внутреннее свойство _queue.
 */
...
void QueueUI::lifecycle() {
    // В начале жизненного цикла неплохо вывести пользователю подсказку по доступным
    // командам
    _printHelp();
